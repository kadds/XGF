...
extern const unsigned int ParticleFireworksPSSize;
extern const unsigned char ParticleFireworksGS[] ;
extern const unsigned int ParticleFireworksGSSize;
extern const unsigned char shaderCubeVS[] ;
extern const unsigned int shaderCubeVSSize;
extern const unsigned char shaderCubePS[] ;
extern const unsigned int shaderCubePSSize;
